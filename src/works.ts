...
export const works: Work[] = [
	...
	},
	{
		...
		title: "Koin",
		description: [
			"In my inaugural venture into the world of Web3 development, I embarked on a project that introduced users to the exciting realm of cryptocurrency. This project was more than just a website; it was an invitation for users to explore the potential of blockchain technology, decentralization, and tokenomics.",
